$(function() {
  ...
  if (navigator.platform) {
    if (
      ...
      targetNode.parents('li').addClass('show');
    }
  }

  $('.az-table .item').click(function() {
    ...
    if (navigator.platform) {
      if (
        ...
        var isActive = target.hasClass('sub-active');

        $('.az-table .item').each(function(i, e){
          $(e).removeClass('sub-active');
        });
