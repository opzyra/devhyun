  ...
  $.extend(EmojiPicker.prototype, {
    ...
    createPicker: function() {
      ...
      this.$picker = $( getPickerHTML() )
        ...
        .height(this.settings.height+32)
        .css('z-index',10000);
    ...
    listen: function() {
      ...
      if (this.settings.button){
        ...
        this.$el.click( $.proxy(this.iconClicked, this) );
      }
    ...
    updatePosition: function() {
      ...
      */
      ...
      // Step 3
      var diffOffset = {
        top: (elOffset.top - parentOffset.top) + 7,
    ...
    clickOutside: function(e) {
      ...
      if ( this.active && !target.hasClass('emoji') ) {
        this.hide();
      }
    },
