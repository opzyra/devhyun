const messages = {
  ...
  required_without_all:
    'The :attr field is required when none of :values are present.',
...
*/
  ...
  validateDigits(name, value, params) {
    ...
    return (
      this.validateNumeric(name, value) && value.toString().length == params[0]
    );
  }
  ...
  validateDigitsBetween(name, value, params) {
    ...
    return (
      this.validateNumeric(name, value) && len >= params[0] && len <= params[1]
    );
  }
